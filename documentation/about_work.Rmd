...
### About the Regional Climate Equity Atlas
...
* Data stories and Regional Climate Equity Atlas:  https<nolink>://github.com/virginiaequitycenter/cville-climate-atlas/
* Data acquisition, processing, and data files:  https<nolink>://github.com/virginiaequitycenter/summer-sandbox/tree/main/cville_region_collection 

### About the Picturing Climate Justice Exhibit
These data are also used in more narrative storytelling as part of the Picturing Climate Justice exhibit in collaboration with the Jefferson School African American Heritage Center.

* See the current data stories at the Picturing Climate Justice: Data Stories site: bit.ly/picturing-climate
* Listen to the ~~Global~~Local Warming data sonification <nolink>: https<nolink>://local-warming.vercel.app
