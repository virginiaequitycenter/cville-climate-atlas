...
author: "Marisa Lemma, Lee LeBoeuf, Michael Salgueiro, Michele Claibourn, Equity Center Democratization of Data Initiative"
output:
  html_document:
    includes:
...
invisible(lapply(list('tidyverse', 'sf','leaflet', 'biscale', 
                      'DT', 'biscale', 'patchwork', 'scales', 
                      'leafem', 'plotly', 'stringi', 'ggpubr'),
...
lead_temp <- merge(lead_temp, ls8_jul4, by = "GEOID")
all <- merge(lead_temp, population, by = "GEOID")
all <- merge(all, nlcd, by = "GEOID")
...
ggsave(plot = legend2, filename = "image/bivariate_legend.svg",
       width = 1, height = 1)
...
leaflet() %>% 
  ...
  addPolygons(data = cvlshapes,
    ...
    addLocalLogo("image/bivariate_legend.svg", src = "local",
...
For an in-depth look at energy burden in the city of Charlottesville and solutions, view the Community Climate Collaborative's work on energy inequity in Charlottesville: https<nolink>://theclimatecollaborative.org/uncovering-energy-inequity

## Back to Story Site

<div class="home-style"><p style="text-align:center;"><a href="https://virginiaequitycenter.github.io/picturing-climate-stories/">Back to <img src="image/story_home_image.png" width="250" style="text-align:center"> Home</a></p></div>
