...
ui <- fluidPage(
  ...
  navbarPage(title = div(
    ...
    "Charlottesville Regional Climate Equity Atlas"
                 ...
                 tabPanel("Atlas",
                          # global instructions
                          tags$div(style='font-size:15px; font-weight:bold; text-align:center;', tags$p("Select any two measures from the dropdown menus on the left and right side of the screen to see the relationship between the measures in census tracts across the Greater Charlottesville Region.")),
